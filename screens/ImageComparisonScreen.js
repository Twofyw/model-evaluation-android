...
export default class ImageComparisonScreen extends React.Component {
    ...
    renderImages() {
        switch (this.state.dataset) {
            case 'road extraction':
                let img_url = global.base_url + dataset_2_dir[this.state.dataset] + "DeepGlobe_test/" + this.state.idx.toString() + "_sat.jpg";
                ...
                return (
                    <View>
                        ...
                        />
                        <Card>
                            <Card.Title title={'Image No.' + this.state.idx.toString()} subtitle="Satellite Imagery" />
